  ...
  Future<int> getNextId() async {
    ...
    try {
      ...
      if (role == DeviceRole.host) {
        ...
        // The manager will validate and throw if there's an issue
      ...
      if (mounted) {
        await _showDialog('❌ Payment Error\n\n'
            'Cannot generate receipt number: ${e.toString()}\n\n'
            'Please ensure:\n'
            '1. The host server is reachable\n'
            '2. The ID service is properly synced\n'
            '3. Contact your administrator if this persists');
      }

      // Re-throw to prevent payment from proceeding
      rethrow;
    }
  }
