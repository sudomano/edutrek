...
class _ViewByScreenState extends State<ViewAllStudentPayments> {
  ...
  Future<Uint8List> generateStudentsPDF(
      List<StudentPayment> student_payments) async {
        ...
        build: (pw.Context context) {
          return [
            pw.Column(
              ...
              children: [
                // Title of the page
                pw.Text('Student Payments Receipts Information',
            ...
            pw.Table.fromTextArray(
              ...
              columnWidths: {
                ...
                4: const pw.FlexColumnWidth(), // Class Name column
                5: const pw.FlexColumnWidth(), // Created On column
                6: const pw.FlexColumnWidth(), // Current Term column
              },
            ),
          ];
        },
  ...
  Widget _buildPaymentsTable() {
    return SingleChildScrollView(
      ...
      child: SingleChildScrollView(
        ...
        physics: const ClampingScrollPhysics(), // Works well with desktops
          ...
          rows: _filteredPayments.map((payment) {
            return DataRow(
              cells: [
                ...
                DataCell(Text(payment.studentClass)),
