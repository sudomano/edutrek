...
import 'package:zitf_system/teachers/teachers_creations/add_teacher.dart';
import 'package:zitf_system/teachers/teachers_creations/delete_teacher.dart';
import 'package:zitf_system/teachers/teachers_creations/teachers_filter.dart';
import 'package:zitf_system/teachers/teachers_creations/update_teacher_screen.dart';

class CreateTeachers extends StatefulWidget {
  const CreateTeachers({super.key});

  @override
  _MyPageState createState() => _MyPageState();
}

class _MyPageState extends State<CreateTeachers> {
                        ...
                        ? GridView.count(
                            ...
                            children: [
                              ...
                              const ElevatedCard(
                                icon: Icons.people,
                                text: 'View Staff',
                                target: ViewTeachersScreenfilter(),
                                isLargeScreen: true,
                              ),
                              const ElevatedCard(
                              ...
                              const ElevatedCard(
                                icon: Icons.update,
                                text: 'Update Staff',
                                target: SelectstaffPaymentPurposeToUpdate(),
                                isLargeScreen: true,
                              ),
                              if (admin || subadmin)
                                const ElevatedCard(
