...
class DeleteTeacherPaymentPurposeScreens extends StatefulWidget {
  const DeleteTeacherPaymentPurposeScreens({super.key});
...
class _DeletePaymentPurposeScreenState
    extends State<DeleteTeacherPaymentPurposeScreens> {
  List<TeacherPaymentsPurposes> _paymentPurposes =
      []; // List to hold payment purposes
  List<TeacherPaymentsPurposes> _selectedPurposes =
  ...
  Future<void> _fetchPaymentPurposes() async {
    final box =
        await Hive.box<TeacherPaymentsPurposes>('teacher_payments_purposes');
