...
import 'package:zitf_system/reusable_codes/reset_all_databases/reset_all_databases.dart';
import 'package:zitf_system/settings/developer_options/domainConfigs/configScreen.dart';

Future<void> developerLoginReset(BuildContext context) async {
  ...
  if (loginSuccess) {
    await resetAppHiveData(context);
    // Now you can navigate somewhere after reset
    Navigator.push(
      context,
