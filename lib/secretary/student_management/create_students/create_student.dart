...
import 'package:google_fonts/google_fonts.dart'; // Custom fontimport 'package:zitf_system/admin/home_screen1.dart';
...
import 'package:zitf_system/secretary/student_management/update_student_sec.dart';
...
import 'package:zitf_system/student_management/view_students.dart';
import 'package:zitf_system/terms/term_switcher1.dart';
import 'package:zitf_system/welcome/welcome_secretary.dart';

class CreateStudents11 extends StatelessWidget {
  const CreateStudents11({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 234, 242, 243),
      ),
      //************* */
            ...
            child: Column(
              ...
              children: [
                ...
                _buildElevatedCard(
                  ...
                  text: 'Add Student',
                  target: const AddStudentScreen(),
                ),
                _buildElevatedCard(
                  context,
                  icon: Icons.person_add,
                  text: 'Update Student',
                  target: const UpdateStudentSecScreen(),
                ),
                _buildElevatedCard(
                  context,
                  icon: Icons.people,
                  text: 'View All Students',
                  target: const ViewStudentsScreen(),
                ),
