...
class UpdateStudentSecScreen extends StatefulWidget {
  const UpdateStudentSecScreen({super.key});

  @override
  _UpdateStudentScreenState createState() => _UpdateStudentScreenState();
}

class _UpdateStudentScreenState extends State<UpdateStudentSecScreen> {
          ...
          child: ListView(
            children: [
              ...
              if (_foundStudent != null) ...[
                ...
                _buildDateField(
                    'Date of Birth (required)', _selectedDateOfBirth, (date) {
                  setState(() {
                ...
                _buildReadOnlyTextField(
                    'Student Registration Position', _regNumberController),
                _buildTextField(
                    'Physical Address  (required)', _physicalAddressController),
                // Guardian  Section
                const SizedBox(height: 20),
                Center(
                  child: const Text('Parent Information',
                      style:
                ...
                const SizedBox(height: 20),
                Center(
                  child: const Text('Religious Information',
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
                ...
                const SizedBox(height: 20),
                Center(
                  child: const Text('Enrollment Information',
                      style:
                          TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
                ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      final updatedStudent = Student(
        ...
        emergencyContactNumber: _emergencyContactNumberController.text.isEmpty
            ? null
            : _emergencyContactNumberController
                .text, // Set operationType to 'update'
      );
