...
class ClassesHomeScreen1 extends StatelessWidget {
  const ClassesHomeScreen1({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                _buildElevatedCard(
                  ...
                  target: const CreateClass(),
                ),
                _buildElevatedCard(
                  context,
                  icon: Icons.people,
                  text: 'View All Classes',
                  target: const ViewClassesScreen(),
                ),
                _buildElevatedCard(
                  context,
                  icon: Icons.search,
                  text: 'Search Class',
                  target: const SearchClassScreen(),
                ),
