...
import 'package:zitf_system/all_payments/payment_purpose/search_payment_purpose.dart';
...
class Createpayments1 extends StatelessWidget {
  const Createpayments1({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                _buildElevatedCard(
                  context,
                  icon: Icons.people,
                  text: 'Search Payment Purpose',
                  target: SearchPaymentPurposeScreen(),
                ),
