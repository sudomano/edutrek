...
class TransactionalEntries extends StatelessWidget {
  const TransactionalEntries({super.key});
                    ...
                    isLargeScreen
                        ? GridView.count(
                            ...
                            children: const [
                              ...
                              ElevatedCard(
                                icon: Icons.money,
                                text: 'Accounts Entries Table',
                                target: TransactionalEntriesHome(),
                                isLargeScreen: true,
                              ),
                              ElevatedCard(
                                icon: Icons.money,
                                text: 'Transactions Entries Table',
                                target: RevenuesHome(),
                                isLargeScreen: true,
                              ),
                              ElevatedCard(
                                icon: Icons.money,
                                text: 'Assets Entries Table',
                                target: AssetEntriesHome(),
                                isLargeScreen: true,
                              ),
                              ElevatedCard(
                                icon: Icons.money,
                                text: 'Depreciation Enties Table',
                                target: RevenuesHome(),
                                isLargeScreen: true,
                              ),
                            ],
