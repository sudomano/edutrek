...
import 'package:zitf_system/reusable_codes/custom_app_bar.dart'; // Importing the global term id
...
class _TermSwitcherState extends State<TermSwitcher> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CustomAppBar(title: 'Switch Terms'),
      body: Container(
  ...
  Widget _buildConfirmButton() {
    return ElevatedButton(
      ...
      style: ElevatedButton.styleFrom(
        ...
        backgroundColor: const Color.fromARGB(255, 227, 230, 235),
        elevation: 3,
