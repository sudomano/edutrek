...
class _ClassRegisterDetailScreenState
    extends State<ClassRegisterDetailScreen> {
  late DateTime _checkDate;
  DateTime? _selectedStartDate;
  DateTime? _selectedEndDate;
  String? _selectedStudentName;
  ...
  void initState() {
    ...
    _classStudents = widget.allStudents
        .where((s) =>
            s.class_.toLowerCase() == widget.className.toLowerCase())
        .toList();
    _applyFilters();
  }
            ...
            onPressed: _filteredStudents.isEmpty
                ...
                : () async {
                    ...
                    if (confirmSave) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(
                            content: Text('PDF preview closed - use share/print from the preview to save.')),
                      );
                    }
                  },
          ),
